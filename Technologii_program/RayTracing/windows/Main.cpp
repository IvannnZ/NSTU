...
int main()
{
    ...
    window.setVerticalSyncEnabled(false); // добавь
    ...
    sf::Shader shader;
    shader.loadFromFile(
        "/home/ivannz/Programing/NSTU/Technologii_program/RayTracing/RealTimeRayTracing/OutputShader.frag",
        sf::Shader::Fragment);
    ...
    while (window.isOpen())
    {
        ...
        // firstTextureSprite.setScale(1.0f, 1.0f);
